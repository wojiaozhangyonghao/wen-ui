...
moment_default.a.suppressDeprecationWarnings = true; // const rowSelection = {
      ...
      var callack = function callack() {
        if (cancel !== false) {
          ...
          _this8.$nextTick(function () {
            ...
            _this8.$emit("input", _this8.tableForm);
          });
        }
      };

      if (typeof this.beforeClose === "function") this.beforeClose(callack);else callack();
    },
...
var components = [packages_crud, packages_form, //     FormTabs,
//     FormSteps,
//     FormDetail,
//     CrudCheckbox,
