...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    console.log(this.page.pageSize, 'page.pageSize'); //初始化动态列
  ...
  mounted: function mounted() {
    console.log(VueDraggableResizable_umd_min_default.a, 'VueDraggableResizable');
  },
  props: {
    value: {
      type: Object,
...
var components = [VueDraggableResizable_umd_min_default.a, packages_crud, packages_form, //     FormTabs,
//     FormSteps,
//     FormDetail,
//     CrudCheckbox,
